        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                >
                    ...
                    <h3 className="text-lg font-medium text-gray-900 group-hover:text-gray-600 transition-colors">Admin Tools</h3>
                    <p className="mt-2 text-sm text-gray-500">Recover deleted items and view system logs.</p>
                </Link>
            </div>
        </div>
    );
