...
${footer}`;
    ...
    const tabs = [
        ...
        { id: 'specs', label: 'Specs & Equipment' },
                ...
                {activeTab === 'general' && (
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="col-span-1 md:col-span-3">
                            <h3 className="text-lg font-bold mb-4 text-gray-800">Vehicle Information</h3>
                        </div>
                    ...
                    activeTab === 'specs' && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="col-span-2">
                                <h3 className="text-lg font-bold mb-4 text-gray-800">Equipment</h3>
                            </div>
                    ...
                    activeTab === 'financials' && (
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                            <div className="col-span-4">
                                <h3 className="text-lg font-bold mb-4 text-gray-800">Vehicle Pricing</h3>
                            </div>
                    ...
                    activeTab === 'logistics' && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="col-span-1 md:col-span-2">
                                <h3 className="text-lg font-bold mb-4 text-gray-800">Location & Staff</h3>
                            </div>
